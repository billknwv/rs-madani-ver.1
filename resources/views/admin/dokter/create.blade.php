...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="page-title mb-0">Tambah Dokter</h4>
            ...
            <form action="{{ route('admin.dokter.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="spesialis_id" class="form-select @error('spesialis_id') is-invalid @enderror" required>
                            ...
                            @foreach($spesialis as $item)
                                <option value="{{ $item->id }}" {{ old('spesialis_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="str" class="form-control @error('str') is-invalid @enderror" value="{{ old('str') }}">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="about" rows="4" class="form-control @error('about') is-invalid @enderror">{{ old('about') }}</textarea>
