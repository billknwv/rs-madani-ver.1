...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="page-title mb-0">Tambah Layanan</h4>
            ...
            <form action="{{ route('admin.layanan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', 'bi-heart-pulse') }}" placeholder="bi-heart-pulse">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="konten" rows="8" class="form-control @error('konten') is-invalid @enderror">{{ old('konten') }}</textarea>
