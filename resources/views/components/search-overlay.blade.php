<div class="search-overlay" id="searchOverlay">
    ...
    <div class="search-overlay-content text-center">
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('layanan.rawat-jalan') }}" class="text-white text-decoration-none small me-2">Rawat Jalan</a>
            <a href="{{ route('layanan.rawat-inap') }}" class="text-white text-decoration-none small me-2">Rawat Inap</a>
            <a href="{{ route('dokter.index') }}" class="text-white text-decoration-none small">Dokter</a>
        </div>
    </div>
</div>