...
@section('title', 'Rawat Inap - RSUD Madani Palu')
@section('meta_description', 'Fasilitas rawat inap RSUD Madani Palu dengan 9 ruangan nyaman dari kelas standar hingga VVIP.')
                    ...
                    <div class="card inap-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer-action">
                                ...
                                <a href="{{ route('kontak.index') }}" class="btn-read-more">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="{{ route('kontak.index') }}" class="btn btn-primary rounded-pill px-4">
