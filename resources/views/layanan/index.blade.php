...
@section('title', 'Layanan RSUD Madani Palu')
@section('meta_description', 'RSUD Madani Palu menyediakan layanan kesehatan lengkap termasuk rawat jalan, rawat inap, IGD 24 jam, dan berbagai klinik spesialis.')
...
@section('content')
    ...
    <section class="section-padding">
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index % 3 * 100 }}">
                    <div class="card klinik-card h-100">
                        <div class="card-img-wrapper">
                            <div class="img-placeholder" style="background: linear-gradient(135deg, {{ $item['gradient_start'] }}, {{ $item['gradient_end'] }});">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer-action">
                                <span class="text-muted small">
                                    <i class="bi bi-clock me-1"></i>{{ $item['jadwal'] }}
                                </span>
                                <a href="{{ route('layanan.rawat-jalan') }}" class="btn-read-more">
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="{{ route('layanan.rawat-jalan') }}" class="btn btn-primary rounded-pill px-4">
    ...
    <section class="section-padding bg-light">
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index % 3 * 100 }}">
                    <div class="card inap-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer-action">
                                <span class="text-muted small">
                                    <i class="bi bi-person-badge me-1"></i>{{ $item['kapasitas'] }}
                                </span>
                                <a href="{{ route('layanan.rawat-inap') }}" class="btn-read-more">
                                    Read More <i class="bi bi-arrow-right"></i>
                                </a>
                            </div>
                        </div>
            ...
            <div class="text-center mt-4" data-aos="fade-up">
                <a href="{{ route('layanan.rawat-inap') }}" class="btn btn-primary rounded-pill px-4">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('dokter.index') }}" class="btn btn-outline-primary rounded-pill px-4 btn-lg">
