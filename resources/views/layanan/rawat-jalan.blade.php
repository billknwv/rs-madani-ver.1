...
@section('title', 'Rawat Jalan - RSUD Madani Palu')
@section('meta_description', 'Layanan rawat jalan RSUD Madani Palu dengan 14 klinik spesialis siap melayani kebutuhan kesehatan Anda.')
                    ...
                    <div class="card klinik-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer-action">
                                ...
                                <a href="{{ route('dokter.index') }}?spesialis={{$loop->index+1}}" class="btn-read-more">
