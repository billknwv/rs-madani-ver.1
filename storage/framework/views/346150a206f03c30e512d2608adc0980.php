<?php $__env->startSection('title', $layanan->nama . ' - RSUD Madani Palu'); ?>
            ...
            <div class="row align-items-center min-vh-40">
                <div class="col-lg-8" data-aos="fade-right">
                    <span class="hero-badge d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill mb-3">
                        <i class="bi <?php echo e($layanan->icon ?? 'bi-heart-pulse'); ?>"></i> <?php echo e(ucfirst($layanan->kategori ?? 'Layanan')); ?>

                    </span>
                    <h1 class="display-4 fw-bold text-white"><?php echo e($layanan->nama); ?></h1>
                    <p class="lead text-white-50"><?php echo e(Str::limit($layanan->deskripsi, 120)); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-8" data-aos="fade-right">
                    <div class="service-content">
                        <h2>Tentang <?php echo e($layanan->nama); ?></h2>
                        <p><?php echo e($layanan->deskripsi); ?></p>
                        <?php echo $layanan->konten; ?>
                    ...
                    <div class="mt-4 d-flex flex-wrap gap-3">
                        ...
                        <a href="<?php echo e(route('dokter.index')); ?>" class="btn btn-outline-primary rounded-pill px-4">
                ...
                <div class="col-lg-4" data-aos="fade-left">
                    <div class="sidebar-service-card">
                        ...
                        <div class="list-group list-group-flush p-2">
                            <?php $__currentLoopData = $allLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('layanan.detail', $item->slug)); ?>"
                                   class="list-group-item list-group-item-action d-flex align-items-center gap-3">
                                    <i class="bi <?php echo e($item->icon ?? 'bi-heart-pulse'); ?> fs-5 text-primary"></i>
    ...
    <section class="section-padding facility-section">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <h2 class="section-title">Fasilitas <?php echo e($layanan->nama); ?></h2>
            ...
            <?php echo $__env->make('components.gallery-fasilitas', ['fasilitas' => $fasilitas], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <a href="<?php echo e(route('layanan.index')); ?>" class="btn btn-outline-primary rounded-pill px-4 btn-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rs-madani\resources\views/layanan/detail.blade.php ENDPATH**/ ?>