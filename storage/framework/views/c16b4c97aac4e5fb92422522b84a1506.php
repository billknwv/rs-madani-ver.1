<?php $__env->startSection('title', 'Profil RSUD Madani Palu - Rumah Sakit Modern & Terpercaya'); ?>

<?php $__env->startSection('meta_description', 'Profil lengkap RSUD Madani Palu, rumah sakit tipe C dengan pelayanan kesehatan profesional dan terpercaya di Sulawesi Tengah.'); ?>
                    ...
                    <div class="card border-0 shadow-sm" data-aos="fade-right">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills profil-nav">
                                <a href="<?php echo e(route('profil.index')); ?>" class="nav-link active">
                                    <i class="bi bi-info-circle me-2"></i>Tentang Kami
                                </a>
                                <a href="<?php echo e(route('profil.sejarah')); ?>" class="nav-link">
                                    <i class="bi bi-clock-history me-2"></i>Sejarah
                                </a>
                                <a href="<?php echo e(route('profil.visi-misi')); ?>" class="nav-link">
                                    <i class="bi bi-bullseye me-2"></i>Visi & Misi
                                </a>
                                <a href="<?php echo e(route('profil.sambutan')); ?>" class="nav-link">
                                    <i class="bi bi-person me-2"></i>Sambutan Direktur
                                </a>
                                <a href="<?php echo e(route('profil.struktur-organisasi')); ?>" class="nav-link">
                                    <i class="bi bi-diagram-3 me-2"></i>Struktur Organisasi
                                </a>
                                <a href="<?php echo e(route('profil.akreditasi')); ?>" class="nav-link">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="profil-content">
                                ...
                                <div class="mt-4 text-center">
                                    <a href="<?php echo e(route('layanan.index')); ?>" class="btn btn-primary rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rs-madani\resources\views/profil/index.blade.php ENDPATH**/ ?>