<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top" id="mainNavbar">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="/">
            ...
            <img src="<?php echo e(asset('logo/logo.svg')); ?>"
                alt="Logo RS Madani"
                height="50"
                class="me-2">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('profil.*') ? 'active' : ''); ?>"
                        href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                        <i class="bi bi-info-circle d-lg-none me-2"></i>Profil
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('profil.index')); ?>"><i class="bi bi-info-circle me-2"></i>Tentang Kami</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profil.sejarah')); ?>"><i class="bi bi-clock-history me-2"></i>Sejarah</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profil.visi-misi')); ?>"><i class="bi bi-bullseye me-2"></i>Visi & Misi</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profil.sambutan')); ?>"><i class="bi bi-person me-2"></i>Sambutan Direktur</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profil.struktur-organisasi')); ?>"><i class="bi bi-diagram-3 me-2"></i>Struktur Organisasi</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profil.akreditasi')); ?>"><i class="bi bi-patch-check me-2"></i>Akreditasi</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown dropdown-mega">
                    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('layanan.*') ? 'active' : ''); ?>"
                        href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                    ...
                    <div class="dropdown-menu dropdown-mega-menu">
                        <div class="mega-menu-container">
                            <div class="row g-0">
                                ...
                                <div class="col-lg-4 mega-col">
                                    <div class="mega-section">
                                        ...
                                        <ul class="mega-links">
                                            <li>
                                                <a href="<?php echo e(route('layanan.detail', 'radiologi')); ?>" class="mega-link">
                                                    <span class="mega-link-icon"><i class="bi bi-x-ray"></i></span>
                                                    <span class="mega-link-text">Radiologi</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('layanan.detail', 'farmasi')); ?>" class="mega-link">
                                                    <span class="mega-link-icon"><i class="bi bi-capsule"></i></span>
                                                    <span class="mega-link-text">Farmasi</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('layanan.detail', 'laboratorium')); ?>" class="mega-link">
                            ...
                            <div class="mega-footer">
                                <a href="<?php echo e(route('layanan.index')); ?>" class="mega-footer-link">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('dokter.*') ? 'active' : ''); ?>" href="<?php echo e(route('dokter.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('kontak.*') ? 'active' : ''); ?>" href="<?php echo e(route('kontak.index')); ?>">
...
<?php /**PATH C:\laragon\www\rs-madani\resources\views/components/navbar.blade.php ENDPATH**/ ?>